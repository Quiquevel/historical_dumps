...
url = "https://santander.pro.dynatrace.cloudcenter.corp/e/a9b631ff-5285-454a-9b3e-4355527a91fd/api"
...
def tokenparameter(token=None,cluster=None,region=None,do_api=None,namespace=None,microservice=None,pod=None, delete=False):
    token = ''
